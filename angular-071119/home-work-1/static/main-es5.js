...
var BackgroundImageUrlPipe = /** @class */ (function () {
    function BackgroundImageUrlPipe() {
    }
    BackgroundImageUrlPipe.prototype.transform = function (img) {
        return "url(" + img + ")";
    };
...
var FilterPipe = /** @class */ (function () {
    ...
    FilterPipe.prototype.transform = function (items, key, value) {
        var stringedSearchValue = String(value).toLowerCase();
        return items.filter(function (item) {
            var stringedItemValue = String(item[key]).toLowerCase();
...
var PhonePipe = /** @class */ (function () {
    ...
    PhonePipe.prototype.transform = function (sourcePhone) {
        var phoneNumber = phone_formatter__WEBPACK_IMPORTED_MODULE_2__["format"](String(sourcePhone), '(NNN) NNN-NNNN');
...
var WeatherWidgetHotelComponent = /** @class */ (function () {
    function WeatherWidgetHotelComponent() {
        this.onSelect = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    Object.defineProperty(WeatherWidgetHotelComponent.prototype, "address", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetHotelComponent.prototype, "img", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetHotelComponent.prototype, "phone", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetHotelComponent.prototype, "socialInfoImg", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetHotelComponent.prototype, "title", {
        get: function () {
    ...
    return WeatherWidgetHotelComponent;
}());
...
var WeatherWidgetHotelsComponent = /** @class */ (function () {
    function WeatherWidgetHotelsComponent() {
        this.hotels = [];
        this.onSelect = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"](true);
    }
    Object.defineProperty(WeatherWidgetHotelsComponent.prototype, "inputHotels", {
        set: function (hotels) {
            this.hotels = hotels;
            if (hotels.length > 0) {
    ...
    WeatherWidgetHotelsComponent.prototype.select = function (hotel) {
    ...
    return WeatherWidgetHotelsComponent;
}());
...
var WeatherWidgetImageComponent = /** @class */ (function () {
    function WeatherWidgetImageComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return WeatherWidgetImageComponent;
}());
...
var WeatherWidgetSocialComponent = /** @class */ (function () {
    function WeatherWidgetSocialComponent() {
    }
    Object.defineProperty(WeatherWidgetSocialComponent.prototype, "title", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetSocialComponent.prototype, "img", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetSocialComponent.prototype, "followers", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetSocialComponent.prototype, "following", {
        get: function () {
    ...
    return WeatherWidgetSocialComponent;
}());
...
var WeatherWidgetSwitcherComponent = /** @class */ (function () {
    function WeatherWidgetSwitcherComponent() {
        this.values = [];
        this.onSwitch = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"](true);
    }
    Object.defineProperty(WeatherWidgetSwitcherComponent.prototype, "inputValues", {
        set: function (values) {
            this.values = values;
            if (values.length > 0) {
    ...
    WeatherWidgetSwitcherComponent.prototype.switch = function (value) {
        this.onSwitch.emit(value);
    };
    WeatherWidgetSwitcherComponent.prototype.trackByValue = function (index, value) {
        return value;
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return WeatherWidgetSwitcherComponent;
}());
...
var WeatherWidgetWeatherComponent = /** @class */ (function () {
    function WeatherWidgetWeatherComponent() {
    }
    Object.defineProperty(WeatherWidgetWeatherComponent.prototype, "title", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetWeatherComponent.prototype, "icon", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetWeatherComponent.prototype, "temperature", {
        get: function () {
    ...
    Object.defineProperty(WeatherWidgetWeatherComponent.prototype, "waterTemperature", {
        get: function () {
    ...
    return WeatherWidgetWeatherComponent;
}());
...
var HotelsTypesPipe = /** @class */ (function () {
    function HotelsTypesPipe() {
    }
    HotelsTypesPipe.prototype.transform = function (hotels) {
        var types = hotels.map(function (hotel) {
            return hotel.type;
        });
...
var WeatherWidgetComponent = /** @class */ (function () {
    ...
    WeatherWidgetComponent.prototype.selectHotel = function (selectedHotel) {
        this.selectedHotel = selectedHotel;
    };
    WeatherWidgetComponent.prototype.switchType = function (selectedType) {
        this.selectedType = selectedType;
    };
    WeatherWidgetComponent.prototype.ngOnInit = function () {
        var _this = this;
        Object(_mock_hotels_mock__WEBPACK_IMPORTED_MODULE_2__["getHotels$"])().subscribe(function (hotels) {
            return _this.hotels = hotels;
        });
    };
...
var WeatherWidgetModule = /** @class */ (function () {
